# Run Jasmine Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Jasmine Tests across real browsers and operating systems.
